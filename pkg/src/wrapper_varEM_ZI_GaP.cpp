...
//' @export
// [[Rcpp::export]]
SEXP wrapper_varEM_ZI_GaP(SEXP Xin, int K, bool ZI,
    ...
    return wrapper_template<gamPoisFactorZI, variationalEM>(X, K, ZI,
                                                            phi01, phi02,
                                                            theta01, theta02,
                                                            alpha1, alpha2,
                                                            beta1, beta2,
