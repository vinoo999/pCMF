...
/*!
* \file gamPoisFactorPen_wrapper.cpp
* \brief definition of wrapper (to call in R) for penalized Gamma Poisson Factor Model
...
#include <RcppEigen.h>
#include <cstdio>
#include "internal/gamPoisFactorSparse.h"
...
// [[Rcpp::export]]
SEXP gamPoisFactorSparse_wrapper(SEXP Xin, int K,
    ...
    gamPoisFactorSparse myModel(n, p, K, iterMax, order,
