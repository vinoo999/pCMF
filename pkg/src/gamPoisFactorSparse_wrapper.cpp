...
/*!
* \file gamPoisFactorZI_wrapper.cpp
...
//' @export
// [[Rcpp::export]]
SEXP gamPoisFactorSparse_wrapper(SEXP Xin, int K, bool ZI,
    ...
    variational<gamPoisFactorSparse> myModel(iterMax, order,
