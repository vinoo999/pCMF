...
#include "internal/model/gamPoisFactorZI.h"
...
// [[Rcpp::export]]
SEXP gamPoisFactorEM_ZI_wrapper(SEXP Xin, int K, bool ZI,
    ...
    variationalEM<gamPoisFactorZI> myModel(iterMax, iterMax_Estep, iterMax_Mstep, order,
