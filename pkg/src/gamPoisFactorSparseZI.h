...
#ifndef gamPoisFactorSparseZI_H
#define gamPoisFactorSparseZI_H

/*!
* \file gamPoisFactorSparseZI.h
...
namespace countMatrixFactor {
    ...
    */
    ...
    class gamPoisFactorSparseZI : public gamPoisFactor {
    ...
    public:
        ...
        * \brief Constructor
        *
        * Constructor of the class gamPoisFactorSparseZI
        */
        gamPoisFactorSparseZI(int n, int p, int K, const MatrixXi &X,
        ...
        * \brief Destructor
        *
        * Destructor of the class gamPoisFactorSparseZI
        */
        ~gamPoisFactorSparseZI();
