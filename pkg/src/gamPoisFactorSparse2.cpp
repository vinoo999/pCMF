...
namespace countMatrixFactor {
    ...
    // CONSTRUCTOR
    gamPoisFactorSparse2::gamPoisFactorSparse2(int n, int p, int K, const MatrixXi &X,
    ...
    // DESTRUCTOR
    gamPoisFactorSparse2::~gamPoisFactorSparse2() {}
    ...
    */
    void gamPoisFactorSparse2::Init() {
    ...
    */
    double gamPoisFactorSparse2::computeELBO() {
    ...
    */
    void gamPoisFactorSparse2::multinomParam() {
    ...
    */
    void gamPoisFactorSparse2::localParam() {
    ...
    */
    void gamPoisFactorSparse2::globalParam() {
    ...
    */
    void gamPoisFactorSparse2::Sproba() {
    ...
    */
    void gamPoisFactorSparse2::updateVarational() {
    ...
    */
    void gamPoisFactorSparse2::priorSproba() {
    ...
    */
    void gamPoisFactorSparse2::localPriorParam() {
    ...
    */
    void gamPoisFactorSparse2::globalPriorParam() {
    ...
    */
    void gamPoisFactorSparse2::updateEstep() {
    ...
    */
    void gamPoisFactorSparse2::updateMstep(int iter) {
        m_curIter = iter;
     ...
     */
    void gamPoisFactorSparse2::returnObject(Rcpp::List &results) {
