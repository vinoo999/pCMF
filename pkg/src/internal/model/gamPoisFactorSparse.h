...
namespace countMatrixFactor {
    ...
    */
    ...
    class gamPoisFactorSparse : public gamPoisFactor {
    ...
    protected:
        ...
        MatrixXd m_ElogU_ElogV_i;   /*!< p x K, \sum_i exp(E[log(U_{ik})]) * exp(E[log(V_{jk})]) */
    ...
    public:
        ...
        */
        gamPoisFactorSparse(int n, int p, int K, const MatrixXi &X,
