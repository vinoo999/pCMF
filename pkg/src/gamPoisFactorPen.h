...
namespace countMatrixFactor {
    ...
    */
    ...
    class gamPoisFactorPen : public gamPoisFactorStandard {

    protected:
        // penalty constant
        VectorXd m_lambda_k;        /*!< penalty constant for l1 constraint on theta_{jk,2} */
    ...
    public:
        ...
        */
        gamPoisFactorPen(int n, int p, int K, int iterMax, int order,
