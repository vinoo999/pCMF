...
/*!
* \file wrapper_varEM_sparse_GaP.cpp.cpp
...
//' @title wrapper_varEM_sparse_GaP.cpp
//' @keywords internal
//'
//' @description
//' Description
...
//' @export
// [[Rcpp::export]]
SEXP wrapper_varEM_sparse_GaP.cpp(SEXP Xin, int K, bool ZI,
    ...
    variationalEM<gamPoisFactorSparse> myModel(iterMax, iterMin, order,
